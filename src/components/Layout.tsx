        ...
        <div className="grid gap-12 border-b border-white/10 pb-12 lg:grid-cols-[1.4fr_0.7fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 max-w-md leading-7 text-[#c7cfdd]">
              De commerciële groeipartner voor bedrijven die structureel meer gekwalificeerde
              afspraken en meer grip op hun salesproces willen.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3">
              {links.map((link) => (
                <Link key={link.to} to={link.to} className="w-fit text-sm text-[#c7cfdd] transition hover:text-white">
                  {link.label}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <p className="mt-5 text-sm leading-6 text-[#c7cfdd]">
              Ontdek tijdens een vrijblijvend strategiegesprek welke commerciële kansen er voor jouw
              bedrijf liggen.
            </p>
            <Link
              to="/contact"
