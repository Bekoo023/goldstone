    ...
    <main>
      <section className="relative overflow-hidden bg-[#f7f5f0] px-5 py-12 sm:px-8 sm:py-16">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1fr_0.85fr]">
          <div>
            <h1 className="text-4xl font-black leading-tight text-[#14213d] sm:text-6xl">
              Commerciële rust voor bedrijven die willen groeien.
            </h1>

            <p className="mt-6 max-w-2xl text-base leading-8 text-[#647089] sm:text-lg">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.82fr_1.18fr]">
          ...
          <div className="space-y-5 text-base leading-8 text-[#647089] sm:text-lg">
            <p>
              ...
              opvolging verschilt per medewerker en resultaten zijn lastig te
              meten.
            </p>

            <p>
              GoldStone brengt daar verandering in. We combineren een
              converterende funnel, pre-kwalificatie, CRM-inzicht en
              persoonlijke appointment setting in één duidelijke werkwijze.
            </p>

            <p>
              Daardoor ontstaat rust. Je weet waar leads vandaan komen, wat
              ermee gebeurt en welke gesprekken daadwerkelijk in jouw agenda
              belanden.
            </p>
          </div>
        </div>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {principles.map(({ title, text, icon: Icon }) => (
              ...
              >
                ...
                <h3 className="mt-7 text-xl font-black text-[#14213d]">
                  {title}
                </h3>
