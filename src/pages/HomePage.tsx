...
const benefits = [
  {
    ...
    text: "Zie precies waar leads binnenkomen, welke opvolging plaatsvindt en waar kansen ontstaan.",
    icon: ChartIcon,
  },
  {
...
const machineSteps = [
  ...
  },
  {
    number: "03",
    title: "Converteren",
    text: "Iedere geschikte lead wordt persoonlijk opgevolgd en direct in jouw agenda gepland.",
